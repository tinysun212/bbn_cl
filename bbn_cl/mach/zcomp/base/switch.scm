...
$Header: switch.scm,v 1.3 88/08/31 10:38:06 jinx Exp $
$MIT-Header: switch.scm,v 4.3 88/03/14 20:24:41 GMT jinx Exp $
...
(define compiler:show-phases? true)
...
(define compiler:touchify? false)
