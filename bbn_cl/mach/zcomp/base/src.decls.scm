...
$Header: src.decls.scm,v 1.2 89/02/08 15:03:41 las Exp $
$MIT-Header: decls.scm,v 4.2 88/01/06 18:30:09 GMT cph Exp $
...
(file-dependency/syntax/join
 (append (filename/append "base"
	 ...
	 (filename/append "machines/butterfly"
...
(define-integration-dependencies "machines/butterfly" "machin" "rtlbase"
  "rtlreg" "rtlty1" "rtlty2")

(define butterfly-base
  (filename/append "machines/butterfly" "machin"))

(define-integration-dependencies "rtlbase" "regset" "base")
(define-integration-dependencies "rtlbase" "rgraph" "base" "cfg1" "cfg2")
(define-integration-dependencies "rtlbase" "rgraph" "machines/butterfly" "machin")
(define-integration-dependencies "rtlbase" "rtlcfg" "base"
  "cfg1" "cfg2" "cfg3")
(define-integration-dependencies "rtlbase" "rtlcon" "base" "cfg3" "utils")
(define-integration-dependencies "rtlbase" "rtlcon" "machines/butterfly" "machin")
...
(define-integration-dependencies "rtlbase" "rtlobj" "base"
  "cfg1" "object" "utils")
(define-integration-dependencies "rtlbase" "rtlreg" "machines/butterfly" "machin")
...
(define-integration-dependencies "rtlbase" "rtlty2" "machines/butterfly" "machin")
...
(file-dependency/integration/join
 (append
  ...
  (filename/append "fgopt"
		   "blktyp" "closan" "conect" "contan" "desenv" "folcon"
		   "offset" "operan" "order" "outer" "simapp" "simple"))
 (append front-end-base butterfly-base))

(file-dependency/integration/join
 (filename/append "rtlgen"
		  "fndblk" "opncod" "rgcomb" "rgproc" "rgretn" "rgrval"
		  "rgstmt" "rtlgen")
 (append front-end-base butterfly-base rtl-base))
...
(file-dependency/integration/join
 ...
 (append butterfly-base rtl-base))
...
(define instruction-base
  (append (filename/append "back" "insseq")
	  (filename/append "machines/butterfly" "assmd" "machin")))

(define lapgen-base
  (append (filename/append "back" "lapgn2" "lapgn3" "regmap")
	  (filename/append "machines/butterfly" "lapgen")))

(define assembler-base
  (append (filename/append "back" "bitutl" "symtab")
	  (filename/append "machines/butterfly" "insutl")))

(define lapgen-body
  (append
   (filename/append "back" "lapgn1" "syntax")
   (filename/append "machines/butterfly" "rules1" "rules2" "rules3" "rules4")))

(define assembler-body
  (append
   (filename/append "back" "bittop")
   (filename/append "machines/butterfly" "instr1" "instr2" "instr3" "instr4")))
