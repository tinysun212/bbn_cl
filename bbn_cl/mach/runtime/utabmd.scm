...
;;; $Header: utabmd.scm,v 13.91 88/08/31 09:13:33 jinx Exp $
;;; $MIT-Header: utabmd.scm,v 9.43 88/03/12 16:08:08 GMT jinx Exp $
...
(vector-set! (get-fixed-objects-vector)
	     ...
	     #(NON-OBJECT				;00
	       ...
	       STATUS-SYMBOLS				;24
	       FUTURE-VECTOR				;25
	       DEFAULT-RESCHEDULER			;26
	       IDLE-RESCHEDULER				;27
	       METERING-ON				;28
	       UCODE-COMMONLISP-MODE			;29
	       CL-SYSTEM-PACKAGE			;2A
	       SCHEDULER-INFO                           ;2B
	       CL-NIL-SYMBOL                            ;2C
	       CL-FIXED-OBJECTS                         ;2D
	       ))
