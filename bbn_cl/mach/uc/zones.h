...

#ifdef METERING
#define Set_Time_Zone(Zone)	SHARED_DATA->Processor_Zone[Who_Am_I] = Zone;
#define Save_Time_Zone(Zone)	Saved_Zone = SHARED_DATA->Processor_Zone[Who_Am_I]; Set_Time_Zone(Zone);
